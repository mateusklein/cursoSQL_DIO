...
--
/*!50003 DROP PROCEDURE IF EXISTS `prc_insere_prod` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `prc_insere_prod`(IN p_categoria VARCHAR(45), IN p_desc VARCHAR(45), IN p_valor DECIMAL(10,2))
BEGIN
    ...
    SAVEPOINT sp_insercao;
    -- ISSO DA ERRO (ELE VOLTARÁ PARA O SAVEPOINT ANTERIOR):
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `prc_insere_prodped` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `prc_insere_prodped`(IN p_idped VARCHAR(45), IN p_idprod VARCHAR(45), IN p_qtd VARCHAR(45), IN p_status VARCHAR(45))
BEGIN
	-- exit da transação caso gerada uma exeção sql
	DECLARE EXIT HANDLER FOR sqlexception
	BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `prc_transacao` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `prc_transacao`()
BEGIN
	-- exit da transação caso gerada uma exeção sql
	DECLARE EXIT HANDLER FOR sqlexception
	BEGIN
    ...
    -- ISSO DA CERTO:
    SET @novo_valor := (SELECT max(idProduto)+1 from produto);
	INSERT INTO PRODUTO VALUES (@novo_valor, 'EXEMPLO_PROC', 'EXEMPLO PROC', 6100.555);
...
--
-- Dumping routines for database 'transactionexample'
--
...
--
/*!50003 DROP PROCEDURE IF EXISTS `PRC_OPERACOES_UNIVERSIDADE` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `PRC_OPERACOES_UNIVERSIDADE`(
    IN var_escolha INT, 
...
-- Dump completed on 2025-03-07 12:12:51
